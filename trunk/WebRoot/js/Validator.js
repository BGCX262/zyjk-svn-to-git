...
var validator = function (formObj) {
    ...
    this.validate = function () {
        ...
        //验证是否允许非空
        var notnull = this.element.getAttribute('notnull');
        if (notnull != null&&notnull=="true" && v.isEmpty()) {
            this.feedback('notnull');
            return false;
        }
        //验证是否合法格式
