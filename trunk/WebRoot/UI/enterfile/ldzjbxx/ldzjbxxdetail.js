        ...
        try {
			 ...
			 onSelectRow:function (data, rowindex, rowobj)
                {      
                       ...
                       $("#enternm").val(data.enternm);
                       $("#zw").val(data.zw);
                       $("#whcd").val(data.whcd);
                       $("#sxzy").val(data.sxzy);
                       $("#byyx").val(data.byyx);
                       $("#lxdh").val(data.lxdh);
                       $("#clzdate").val(data.clzdate);
                       $("#zsno").val(data.zsno);
                       $("#yxq").val(data.yxq);
           ...
           var colselect = $("#name").ligerComboBox({
                width: 250,
                slide: false,
                selectBoxWidth: 500,
                selectBoxHeight: 240, 
          ...
          var columntree  =colselect.grid.ligerGetGridManager();       
             ...
             if(method=="add"){
               actionurl=webpath+"/UI/action/ldzjbxx/LdzjbxxAction_insert.action";
             }else if(method=="look"){
               $("#subButton").hide();
                $("#colButton").hide();
             }else if(method=="update"){
                actionurl=webpath+"/UI/action/ldzjbxx/LdzjbxxAction_update.action";
             } 
