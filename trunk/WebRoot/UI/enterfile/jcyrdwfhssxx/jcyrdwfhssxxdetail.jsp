...
--%><form name="form" method="post"  id="form">
     <div>
         ...
         <input type="hidden" id="jcdwbh" name="jcyrdwfhssxxbean.jcdwbh" value="<%=jcyrdwfhssxxbean.getJcdwbh() %>"/>
        ...
        <table cellpadding="0" cellspacing="0" class="form-l-table-edit" align="center">
            <tr>
                ...
                <td class="l-table-edit-td-left" style="width:160px">
                   <input name="jcyrdwfhssxxbean.jcdwmc" type="text" id="jcdwmc" value="<%=jcyrdwfhssxxbean.getJcdwmc() %>" ltype="text" onkeyup="getEnterinfo(this.value)" validate="{required:true }" />
