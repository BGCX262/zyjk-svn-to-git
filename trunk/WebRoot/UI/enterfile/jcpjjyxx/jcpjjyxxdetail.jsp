...
<%@ include file="/global.jsp"%>
 ...
 %>
    <script language="javascript" src="<%=webpath%>/UI/enterfile/jcpjjyxx/jcpjjyxxdetail.js"></script>
  </head>
     ...
     <div>
        ...
        <table cellpadding="0" cellspacing="0" class="form-l-table-edit" align="center">
            <tr>
                ...
                <td class="l-table-edit-td-left" style="width:160px">
                   <input name="jcpjjyxxbean.jcdwmc" type="text" id="jcdwmc" value="<%=jcpjjyxxbean.getJcdwmc() %>" ltype="text" onkeyup="getEnterinfo(this.value)"  validate="{required:true }" />
