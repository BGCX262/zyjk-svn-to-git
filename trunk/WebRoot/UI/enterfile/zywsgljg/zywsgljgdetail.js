 ...
 ****************************************************/
        ...
        try {
			 ...
			 parms:{strWhere:" and enterno like '%"+ $("#enterno").val() +"%'"},
          ...
          var columntree  =colselect.grid.ligerGetGridManager();   
             ...
             if(method=="add"){
               actionurl=webpath+"/UI/action/zywsgljg/ZywsgljgAction_insert.action";
             }else if(method=="look"){
               $("#subButton").hide();
               $("#colButton").hide();
             }else if(method=="update"){
                actionurl=webpath+"/UI/action/zywsgljg/ZywsgljgAction_update.action";
             } 
