        ...
        try {
           ...
           $.post(webpath+"/st/system/action/table/table_getColumn.action",{key:'cxtjjgGrid'},function(data){
			 ...
			 pageSize:15,
			  onSelectRow:function (data, rowindex, rowobj)
                {      
                       $("#zddwbh").val(data.sysno);
                       $("#zddwmc").val(data.jgmc);
                      // $("#dwdz").val(data.zcdz);
                       //$("#sex").val(data.sex);
          ...
          var columntree  =colselect.grid.ligerGetGridManager();       
             ...
             */
             ...
             if(method=="add"){
               actionurl=webpath+"/UI/action/ldzzybzlqk/LdzzybzlqkAction_insert.action";
             }else if(method=="look"){
               $("#subButton").hide();
               $("#colButton").hide();
             }else if(method=="update"){
                actionurl=webpath+"/UI/action/ldzzybzlqk/LdzzybzlqkAction_update.action";
             } 
