 ...
 ****************************************************/
        ...
        try {
          ...
          var columntree  =colselect.grid.ligerGetGridManager();   
             ...
             if(method=="add"){
               actionurl=webpath+"/UI/action/qyxfzybxx/QyxfzybxxAction_insert.action";
             }else if(method=="look"){
               $("#subButton").hide();
               $("#colButton").hide();
             }else if(method=="update"){
                actionurl=webpath+"/UI/action/qyxfzybxx/QyxfzybxxAction_update.action";
             } 
