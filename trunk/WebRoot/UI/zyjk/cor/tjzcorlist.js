...
try{
 ...
 discode=getUrlParam("distcode");
 var chanzhi=getUrlParam("chanzhi");
 var hyfl=getUrlParam("hyfl");
 var whys=getUrlParam("whys");
  var strWhere = " "; 
   ...
   if(null!=chanzhi&&chanzhi.length>0){
			strWhere+=" and chanzhi ='"+chanzhi+"'";
			
		}
	
	if(null!=hyfl&&hyfl.length>0){
			strWhere+=" and hyfl like'"+hyfl+"%'";
			
		}
	if(null!=whys&&whys.length>0){
			strWhere+=" and corpkey in (select corpkey from Z_wh where whDM like '"+whys+"%')";
