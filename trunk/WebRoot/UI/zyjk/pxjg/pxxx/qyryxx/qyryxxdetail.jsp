...
<%@ include file="/global.jsp"%>
 ...
 %>
  ...
  <script language="javascript" src="<%=webpath%>/UI/zyjk/pxjg/pxxx/qyryxx/qyryxxdetail.js"></script>
  </head>
  
  <body class="menubody" style="width: 615">
        ...
        <table cellpadding="0" cellspacing="0" class="form-l-table-edit" align="center">
            <tr>
                ...
                <td class="l-table-edit-td-left" >
                   <input name="qyryxxbean.enternm"  type="text" id="enternm" value="<%=qyryxxbean.getEnternm() %>" ltype="text" validate="{required:true }" />
                </td>
            ...
            <tr>
             ...
             <tr>
                ...
                <td class="l-table-edit-td-left" >
                   <input name="qyryxxbean.byyx" type="text" id="byyx" value="<%=qyryxxbean.getByyx() %>" ltype="text" validate="{required:true }" />
                </td>
                <td class="td_message"></td>
            ...
            <tr>
                ...
                <td class="l-table-edit-td-left">
                   <input name="qyryxxbean.clzdate" type="text" id="clzdate" value="<%=qyryxxbean.getClzdate() %>" ltype="date" validate="{required:true }" />
                </td>
                <td class="td_message"></td>
                <td class="l-table-edit-td-right">证书编号：</td>
                <td class="l-table-edit-td-left" >
                   <input name="qyryxxbean.zsno" type="text" id="zsno" value="<%=qyryxxbean.getZsno() %>" ltype="text" validate="{required:true }" />
                </td>
                <td class="td_message"></td>
             ...
             <tr>
                ...
                <td class="l-table-edit-td-left">
                   <input name="qyryxxbean.yxq" type="text" id="yxq" value="<%=qyryxxbean.getYxq() %>" ltype="date" validate="{required:true }" />
                </td>
                <td class="td_message"></td>
                <td class="l-table-edit-td-right">培训机构名称：</td>
                <td class="l-table-edit-td-left" >
                   <input name="qyryxxbean.pxjgmc" type="text" id="pxjgmc" value="<%=qyryxxbean.getPxjgmc() %>" ltype="text" validate="{required:true }" />
                </td>
                <td class="td_message"></td>
            ...
            <tr>
               <td class="l-table-edit-td-right">所在部门：</td>
                <td class="l-table-edit-td-left" >
                   <input name="qyryxxbean.deptname" type="text" id="deptname" value="<%=qyryxxbean.getDeptname() %>" ltype="text" validate="{required:true }" />
                </td>
                <td class="td_message"></td>
            ...
            <tr>
                ...
                <td class="l-table-edit-td-left"  >
                   <input name="qyryxxbean.hzdate" type="text" id="hzdate" value="<%=qyryxxbean.getHzdate()%>" ltype="date" validate="{required:true }" />
                </td>
                <td class="td_message"></td>
            ...
            <tr>
                ...
                <td class="l-table-edit-td-left"  colspan="7">
                <textarea  class="l-textarea"  cols="110"  rows="4" id="hj" name="qyryxxbean.hj"  
