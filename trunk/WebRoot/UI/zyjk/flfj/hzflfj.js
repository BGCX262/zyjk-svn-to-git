...
try{
 ...
 discode=$("#discode").val();
	...
	var zhuguan=getUrlParam("zhuguan");
	if(null!=zhuguan&&zhuguan!=""&&zhuguan!="null"){
			if(zhuguan=="1"){
				whereStr+=" and ( corpkey in (select Z_cor.corpkey from Z_cor where zhuguan not in ('县属企业')) or bak4='1' )";
			}
	}
