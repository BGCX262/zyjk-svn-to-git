...
try{
 ...
 grid = sub_Grid('pcpjjyGrid','劳动者职业史',toolbar,"");
        }catch (e) {
 ...
 try {
  myWindow = top.$.ligerDialog.open({url:webpath+"/UI/action/jcpjjyxx/LdzcysAction_findByKey.action?messageBean.method=look&enterno="+ getUrlParam("enterno") +"&strSysno="+data.sysno, width: openWidth,height:openHeight, title:"劳动者职业史",
