...
--%><form name="form" method="post"  id="form">
     <div>
        ...
        <table id="01" style="display:none" cellpadding="0" cellspacing="0" class="form-l-table-edit" align="center">
        <tr>
        ...
        <table id="0205" style="display:none" cellpadding="0" cellspacing="0" class="form-l-table-edit" align="center">
        <tr>
        ...
        <table id="030406" style="display:none" cellpadding="0" cellspacing="0" class="form-l-table-edit" align="center">
            <tr>
        ...
        <table id="07" style="display:none" cellpadding="0" cellspacing="0" class="form-l-table-edit" align="center">
           <tr>
        ...
        <table id="08" style="display:none" cellpadding="0" cellspacing="0" class="form-l-table-edit" align="center">
          <tr>
        ...
        <table id="09" style="display:none" cellpadding="0" cellspacing="0" class="form-l-table-edit" align="center">
        ...
        <table id="10" style="display:none" cellpadding="0" cellspacing="0" class="form-l-table-edit" align="center">
            <tr>
        ...
        <table id="11" style="display:none" cellpadding="0" cellspacing="0" class="form-l-table-edit" align="center">
            <tr>
