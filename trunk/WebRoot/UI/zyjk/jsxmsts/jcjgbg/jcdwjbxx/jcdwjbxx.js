...
try{
 ...
 grid = sub_Grid('bjcdwjbxxGrid','劳动者职业史',toolbar,"");
        }catch (e) {
...
$.ligerDialog.error(e.message);
     ...
     function f_search(){
        ...
        if (strId==null||strId.length == 0) {
         ...
         myWindow = top.$.ligerDialog.open({url: webpath+"/UI/action/jcdwjbxx/JcdwjbxxAction_findByKey.action?messageBean.method=update&enterno="+ getUrlParam("enterno") +"&strSysno="+strId, width: openWidth,height:openHeight, title: '劳动者职业史',
         showMax: false, showToggle: false, showMin: false, isResize: false, slide: false }); 
        // f_search(); 
        }
        }catch (e) {
