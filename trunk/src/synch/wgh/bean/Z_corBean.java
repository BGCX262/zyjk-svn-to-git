...
public class Z_corBean extends AbstractBasicBean implements Cloneable {
     public static List find(String sSqlWhere) throws Exception{           return new Z_corBean().findByWhere(sSqlWhere);      }       public static List findAndLock(String sSqlWhere)throws Exception {           return new Z_corBean().findAndLockByWhere(sSqlWhere);      }       public static Z_corBean findFirst(String sSqlWhere)throws Exception {           return (Z_corBean)new Z_corBean().findFirstByWhere(sSqlWhere);      }       public static Z_corBean findFirstAndLock(String sSqlWhere)throws Exception {           return (Z_corBean)new Z_corBean().findFirstAndLockByWhere(sSqlWhere);      }            public static RecordSet findRecordSet(String sSqlWhere) throws Exception{           return new Z_corBean().findRecordSetByWhere(sSqlWhere);      }       public static List find(String sSqlWhere,boolean isAutoRelease)throws Exception {           Z_corBean bean = new Z_corBean();           bean.setAutoRelease(isAutoRelease);           return bean.findByWhere(sSqlWhere);      }       public static List findAndLock(String sSqlWhere,boolean isAutoRelease) throws Exception{           Z_corBean bean = new Z_corBean();           bean.setAutoRelease(isAutoRelease);           return bean.findAndLockByWhere(sSqlWhere);      }       public static Z_corBean findFirst(String sSqlWhere,boolean isAutoRelease)throws Exception {           Z_corBean bean = new Z_corBean();           bean.setAutoRelease(isAutoRelease);           return (Z_corBean)bean.findFirstByWhere(sSqlWhere);      }       public static Z_corBean findFirstAndLock(String sSqlWhere,boolean isAutoRelease) throws Exception{           Z_corBean bean = new Z_corBean();           bean.setAutoRelease(isAutoRelease);           return (Z_corBean)bean.findFirstAndLockByWhere(sSqlWhere);      }       public static RecordSet findRecordSet(String sSqlWhere,boolean isAutoRelease)throws Exception {           Z_corBean bean = new Z_corBean();           bean.setAutoRelease(isAutoRelease);           return bean.findRecordSetByWhere(sSqlWhere);      } String  corpkey;
String  dwmc;
String  jcdate;
String  zcdz;
String  zcyzbm;
...
String  wghdq4;
String  wghdq5;
public static final String TABLENAME ="z_cor";
private String operate_mode = "add";
public ChangeFileds cf = new ChangeFileds();
public String getTableName() {return TABLENAME;}
public void addObject(List list,RecordSet rs) {
Z_corBean abb = new Z_corBean();
...
}public void init(ActionRequest actionRequest) throws Exception { this.init(0,actionRequest);}public void initAll(int i,ActionRequest actionRequest) throws Exception { this.init(i,actionRequest);}public void initAll(ActionRequest actionRequest) throws Exception { this.initAll(0,actionRequest);}public Object clone() throws CloneNotSupportedException { Z_corBean obj = (Z_corBean)super.clone();obj.setCorpkey(obj.corpkey);
