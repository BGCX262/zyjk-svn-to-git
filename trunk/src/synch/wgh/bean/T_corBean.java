package synch.wgh.bean;
import java.util.*;
import st.platform.db.*;
 import st.platform.db.sql.*;
import st.platform.control.business.ActionRequest;
public class T_corBean extends AbstractBasicBean implements Cloneable {
     public static List find(String sSqlWhere) throws Exception{           return new T_corBean().findByWhere(sSqlWhere);      }       public static List findAndLock(String sSqlWhere)throws Exception {           return new T_corBean().findAndLockByWhere(sSqlWhere);      }       public static T_corBean findFirst(String sSqlWhere)throws Exception {           return (T_corBean)new T_corBean().findFirstByWhere(sSqlWhere);      }       public static T_corBean findFirstAndLock(String sSqlWhere)throws Exception {           return (T_corBean)new T_corBean().findFirstAndLockByWhere(sSqlWhere);      }            public static RecordSet findRecordSet(String sSqlWhere) throws Exception{           return new T_corBean().findRecordSetByWhere(sSqlWhere);      }       public static List find(String sSqlWhere,boolean isAutoRelease)throws Exception {           T_corBean bean = new T_corBean();           bean.setAutoRelease(isAutoRelease);           return bean.findByWhere(sSqlWhere);      }       public static List findAndLock(String sSqlWhere,boolean isAutoRelease) throws Exception{           T_corBean bean = new T_corBean();           bean.setAutoRelease(isAutoRelease);           return bean.findAndLockByWhere(sSqlWhere);      }       public static T_corBean findFirst(String sSqlWhere,boolean isAutoRelease)throws Exception {           T_corBean bean = new T_corBean();           bean.setAutoRelease(isAutoRelease);           return (T_corBean)bean.findFirstByWhere(sSqlWhere);      }       public static T_corBean findFirstAndLock(String sSqlWhere,boolean isAutoRelease) throws Exception{           T_corBean bean = new T_corBean();           bean.setAutoRelease(isAutoRelease);           return (T_corBean)bean.findFirstAndLockByWhere(sSqlWhere);      }       public static RecordSet findRecordSet(String sSqlWhere,boolean isAutoRelease)throws Exception {           T_corBean bean = new T_corBean();           bean.setAutoRelease(isAutoRelease);           return bean.findRecordSetByWhere(sSqlWhere);      } String  corpkey;
String  dwmc;
String  jcdate;
String  zcdz;
String  zcyzbm;
...
String  wghdq4;
String  wghdq5;
public static final String TABLENAME ="t_cor";
private String operate_mode = "add";
public ChangeFileds cf = new ChangeFileds();
public String getTableName() {return TABLENAME;}
public void addObject(List list,RecordSet rs) {
T_corBean abb = new T_corBean();
...
}public void init(ActionRequest actionRequest) throws Exception { this.init(0,actionRequest);}public void initAll(int i,ActionRequest actionRequest) throws Exception { this.init(i,actionRequest);}public void initAll(ActionRequest actionRequest) throws Exception { this.initAll(0,actionRequest);}public Object clone() throws CloneNotSupportedException { T_corBean obj = (T_corBean)super.clone();obj.setCorpkey(obj.corpkey);
