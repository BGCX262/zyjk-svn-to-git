...
public class B_scclBean extends AbstractBasicBean implements Cloneable {
     public static List find(String sSqlWhere) throws Exception{           return new B_scclBean().findByWhere(sSqlWhere);      }       public static List findAndLock(String sSqlWhere)throws Exception {           return new B_scclBean().findAndLockByWhere(sSqlWhere);      }       public static B_scclBean findFirst(String sSqlWhere)throws Exception {           return (B_scclBean)new B_scclBean().findFirstByWhere(sSqlWhere);      }       public static B_scclBean findFirstAndLock(String sSqlWhere)throws Exception {           return (B_scclBean)new B_scclBean().findFirstAndLockByWhere(sSqlWhere);      }            public static RecordSet findRecordSet(String sSqlWhere) throws Exception{           return new B_scclBean().findRecordSetByWhere(sSqlWhere);      }       public static List find(String sSqlWhere,boolean isAutoRelease)throws Exception {           B_scclBean bean = new B_scclBean();           bean.setAutoRelease(isAutoRelease);           return bean.findByWhere(sSqlWhere);      }       public static List findAndLock(String sSqlWhere,boolean isAutoRelease) throws Exception{           B_scclBean bean = new B_scclBean();           bean.setAutoRelease(isAutoRelease);           return bean.findAndLockByWhere(sSqlWhere);      }       public static B_scclBean findFirst(String sSqlWhere,boolean isAutoRelease)throws Exception {           B_scclBean bean = new B_scclBean();           bean.setAutoRelease(isAutoRelease);           return (B_scclBean)bean.findFirstByWhere(sSqlWhere);      }       public static B_scclBean findFirstAndLock(String sSqlWhere,boolean isAutoRelease) throws Exception{           B_scclBean bean = new B_scclBean();           bean.setAutoRelease(isAutoRelease);           return (B_scclBean)bean.findFirstAndLockByWhere(sSqlWhere);      }       public static RecordSet findRecordSet(String sSqlWhere,boolean isAutoRelease)throws Exception {           B_scclBean bean = new B_scclBean();           bean.setAutoRelease(isAutoRelease);           return bean.findRecordSetByWhere(sSqlWhere);      } String  corpkey;
String  mc;
String  nianliang;
String  danwei;
String  id;
String  bakdate;
public static final String TABLENAME ="b_sccl";
private String operate_mode = "add";
public ChangeFileds cf = new ChangeFileds();
public String getTableName() {return TABLENAME;}
public void addObject(List list,RecordSet rs) {
B_scclBean abb = new B_scclBean();
...
}public void init(ActionRequest actionRequest) throws Exception { this.init(0,actionRequest);}public void initAll(int i,ActionRequest actionRequest) throws Exception { this.init(i,actionRequest);}public void initAll(ActionRequest actionRequest) throws Exception { this.initAll(0,actionRequest);}public Object clone() throws CloneNotSupportedException { B_scclBean obj = (B_scclBean)super.clone();obj.setCorpkey(obj.corpkey);
obj.setMc(obj.mc);
