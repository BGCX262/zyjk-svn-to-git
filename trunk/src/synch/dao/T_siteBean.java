...
public class T_siteBean extends AbstractBasicBean implements Cloneable {
     public static List find(String sSqlWhere) throws Exception{           return new T_siteBean().findByWhere(sSqlWhere);      }       public static List findAndLock(String sSqlWhere)throws Exception {           return new T_siteBean().findAndLockByWhere(sSqlWhere);      }       public static T_siteBean findFirst(String sSqlWhere)throws Exception {           return (T_siteBean)new T_siteBean().findFirstByWhere(sSqlWhere);      }       public static T_siteBean findFirstAndLock(String sSqlWhere)throws Exception {           return (T_siteBean)new T_siteBean().findFirstAndLockByWhere(sSqlWhere);      }            public static RecordSet findRecordSet(String sSqlWhere) throws Exception{           return new T_siteBean().findRecordSetByWhere(sSqlWhere);      }       public static List find(String sSqlWhere,boolean isAutoRelease)throws Exception {           T_siteBean bean = new T_siteBean();           bean.setAutoRelease(isAutoRelease);           return bean.findByWhere(sSqlWhere);      }       public static List findAndLock(String sSqlWhere,boolean isAutoRelease) throws Exception{           T_siteBean bean = new T_siteBean();           bean.setAutoRelease(isAutoRelease);           return bean.findAndLockByWhere(sSqlWhere);      }       public static T_siteBean findFirst(String sSqlWhere,boolean isAutoRelease)throws Exception {           T_siteBean bean = new T_siteBean();           bean.setAutoRelease(isAutoRelease);           return (T_siteBean)bean.findFirstByWhere(sSqlWhere);      }       public static T_siteBean findFirstAndLock(String sSqlWhere,boolean isAutoRelease) throws Exception{           T_siteBean bean = new T_siteBean();           bean.setAutoRelease(isAutoRelease);           return (T_siteBean)bean.findFirstAndLockByWhere(sSqlWhere);      }       public static RecordSet findRecordSet(String sSqlWhere,boolean isAutoRelease)throws Exception {           T_siteBean bean = new T_siteBean();           bean.setAutoRelease(isAutoRelease);           return bean.findRecordSetByWhere(sSqlWhere);      } String  corpkey;
String  zymc;
String  miaoshu;
String  id;
String  jcrenshu;
public static final String TABLENAME ="t_site";
private String operate_mode = "add";
public ChangeFileds cf = new ChangeFileds();
public String getTableName() {return TABLENAME;}
public void addObject(List list,RecordSet rs) {
T_siteBean abb = new T_siteBean();
...
}public void init(ActionRequest actionRequest) throws Exception { this.init(0,actionRequest);}public void initAll(int i,ActionRequest actionRequest) throws Exception { this.init(i,actionRequest);}public void initAll(ActionRequest actionRequest) throws Exception { this.initAll(0,actionRequest);}public Object clone() throws CloneNotSupportedException { T_siteBean obj = (T_siteBean)super.clone();obj.setCorpkey(obj.corpkey);
