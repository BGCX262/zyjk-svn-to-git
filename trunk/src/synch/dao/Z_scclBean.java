...
public class Z_scclBean extends AbstractBasicBean implements Cloneable {
     public static List find(String sSqlWhere) throws Exception{           return new Z_scclBean().findByWhere(sSqlWhere);      }       public static List findAndLock(String sSqlWhere)throws Exception {           return new Z_scclBean().findAndLockByWhere(sSqlWhere);      }       public static Z_scclBean findFirst(String sSqlWhere)throws Exception {           return (Z_scclBean)new Z_scclBean().findFirstByWhere(sSqlWhere);      }       public static Z_scclBean findFirstAndLock(String sSqlWhere)throws Exception {           return (Z_scclBean)new Z_scclBean().findFirstAndLockByWhere(sSqlWhere);      }            public static RecordSet findRecordSet(String sSqlWhere) throws Exception{           return new Z_scclBean().findRecordSetByWhere(sSqlWhere);      }       public static List find(String sSqlWhere,boolean isAutoRelease)throws Exception {           Z_scclBean bean = new Z_scclBean();           bean.setAutoRelease(isAutoRelease);           return bean.findByWhere(sSqlWhere);      }       public static List findAndLock(String sSqlWhere,boolean isAutoRelease) throws Exception{           Z_scclBean bean = new Z_scclBean();           bean.setAutoRelease(isAutoRelease);           return bean.findAndLockByWhere(sSqlWhere);      }       public static Z_scclBean findFirst(String sSqlWhere,boolean isAutoRelease)throws Exception {           Z_scclBean bean = new Z_scclBean();           bean.setAutoRelease(isAutoRelease);           return (Z_scclBean)bean.findFirstByWhere(sSqlWhere);      }       public static Z_scclBean findFirstAndLock(String sSqlWhere,boolean isAutoRelease) throws Exception{           Z_scclBean bean = new Z_scclBean();           bean.setAutoRelease(isAutoRelease);           return (Z_scclBean)bean.findFirstAndLockByWhere(sSqlWhere);      }       public static RecordSet findRecordSet(String sSqlWhere,boolean isAutoRelease)throws Exception {           Z_scclBean bean = new Z_scclBean();           bean.setAutoRelease(isAutoRelease);           return bean.findRecordSetByWhere(sSqlWhere);      } String  corpkey;
String  mc;
String  nianliang;
String  danwei;
String  id;
public static final String TABLENAME ="z_sccl";
private String operate_mode = "add";
public ChangeFileds cf = new ChangeFileds();
public String getTableName() {return TABLENAME;}
public void addObject(List list,RecordSet rs) {
Z_scclBean abb = new Z_scclBean();
...
}public void init(ActionRequest actionRequest) throws Exception { this.init(0,actionRequest);}public void initAll(int i,ActionRequest actionRequest) throws Exception { this.init(i,actionRequest);}public void initAll(ActionRequest actionRequest) throws Exception { this.initAll(0,actionRequest);}public Object clone() throws CloneNotSupportedException { Z_scclBean obj = (Z_scclBean)super.clone();obj.setCorpkey(obj.corpkey);
obj.setMc(obj.mc);
