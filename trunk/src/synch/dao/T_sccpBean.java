...
public class T_sccpBean extends AbstractBasicBean implements Cloneable {
     public static List find(String sSqlWhere) throws Exception{           return new T_sccpBean().findByWhere(sSqlWhere);      }       public static List findAndLock(String sSqlWhere)throws Exception {           return new T_sccpBean().findAndLockByWhere(sSqlWhere);      }       public static T_sccpBean findFirst(String sSqlWhere)throws Exception {           return (T_sccpBean)new T_sccpBean().findFirstByWhere(sSqlWhere);      }       public static T_sccpBean findFirstAndLock(String sSqlWhere)throws Exception {           return (T_sccpBean)new T_sccpBean().findFirstAndLockByWhere(sSqlWhere);      }            public static RecordSet findRecordSet(String sSqlWhere) throws Exception{           return new T_sccpBean().findRecordSetByWhere(sSqlWhere);      }       public static List find(String sSqlWhere,boolean isAutoRelease)throws Exception {           T_sccpBean bean = new T_sccpBean();           bean.setAutoRelease(isAutoRelease);           return bean.findByWhere(sSqlWhere);      }       public static List findAndLock(String sSqlWhere,boolean isAutoRelease) throws Exception{           T_sccpBean bean = new T_sccpBean();           bean.setAutoRelease(isAutoRelease);           return bean.findAndLockByWhere(sSqlWhere);      }       public static T_sccpBean findFirst(String sSqlWhere,boolean isAutoRelease)throws Exception {           T_sccpBean bean = new T_sccpBean();           bean.setAutoRelease(isAutoRelease);           return (T_sccpBean)bean.findFirstByWhere(sSqlWhere);      }       public static T_sccpBean findFirstAndLock(String sSqlWhere,boolean isAutoRelease) throws Exception{           T_sccpBean bean = new T_sccpBean();           bean.setAutoRelease(isAutoRelease);           return (T_sccpBean)bean.findFirstAndLockByWhere(sSqlWhere);      }       public static RecordSet findRecordSet(String sSqlWhere,boolean isAutoRelease)throws Exception {           T_sccpBean bean = new T_sccpBean();           bean.setAutoRelease(isAutoRelease);           return bean.findRecordSetByWhere(sSqlWhere);      } String  corpkey;
String  mc;
String  nianliang;
String  danwei;
String  id;
public static final String TABLENAME ="t_sccp";
private String operate_mode = "add";
public ChangeFileds cf = new ChangeFileds();
public String getTableName() {return TABLENAME;}
public void addObject(List list,RecordSet rs) {
T_sccpBean abb = new T_sccpBean();
...
}public void init(ActionRequest actionRequest) throws Exception { this.init(0,actionRequest);}public void initAll(int i,ActionRequest actionRequest) throws Exception { this.init(i,actionRequest);}public void initAll(ActionRequest actionRequest) throws Exception { this.initAll(0,actionRequest);}public Object clone() throws CloneNotSupportedException { T_sccpBean obj = (T_sccpBean)super.clone();obj.setCorpkey(obj.corpkey);
obj.setMc(obj.mc);
