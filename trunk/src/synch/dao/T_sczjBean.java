...
public class T_sczjBean extends AbstractBasicBean implements Cloneable {
     public static List find(String sSqlWhere) throws Exception{           return new T_sczjBean().findByWhere(sSqlWhere);      }       public static List findAndLock(String sSqlWhere)throws Exception {           return new T_sczjBean().findAndLockByWhere(sSqlWhere);      }       public static T_sczjBean findFirst(String sSqlWhere)throws Exception {           return (T_sczjBean)new T_sczjBean().findFirstByWhere(sSqlWhere);      }       public static T_sczjBean findFirstAndLock(String sSqlWhere)throws Exception {           return (T_sczjBean)new T_sczjBean().findFirstAndLockByWhere(sSqlWhere);      }            public static RecordSet findRecordSet(String sSqlWhere) throws Exception{           return new T_sczjBean().findRecordSetByWhere(sSqlWhere);      }       public static List find(String sSqlWhere,boolean isAutoRelease)throws Exception {           T_sczjBean bean = new T_sczjBean();           bean.setAutoRelease(isAutoRelease);           return bean.findByWhere(sSqlWhere);      }       public static List findAndLock(String sSqlWhere,boolean isAutoRelease) throws Exception{           T_sczjBean bean = new T_sczjBean();           bean.setAutoRelease(isAutoRelease);           return bean.findAndLockByWhere(sSqlWhere);      }       public static T_sczjBean findFirst(String sSqlWhere,boolean isAutoRelease)throws Exception {           T_sczjBean bean = new T_sczjBean();           bean.setAutoRelease(isAutoRelease);           return (T_sczjBean)bean.findFirstByWhere(sSqlWhere);      }       public static T_sczjBean findFirstAndLock(String sSqlWhere,boolean isAutoRelease) throws Exception{           T_sczjBean bean = new T_sczjBean();           bean.setAutoRelease(isAutoRelease);           return (T_sczjBean)bean.findFirstAndLockByWhere(sSqlWhere);      }       public static RecordSet findRecordSet(String sSqlWhere,boolean isAutoRelease)throws Exception {           T_sczjBean bean = new T_sczjBean();           bean.setAutoRelease(isAutoRelease);           return bean.findRecordSetByWhere(sSqlWhere);      } String  corpkey;
String  mc;
String  nianliang;
String  danwei;
String  id;
public static final String TABLENAME ="t_sczj";
private String operate_mode = "add";
public ChangeFileds cf = new ChangeFileds();
public String getTableName() {return TABLENAME;}
public void addObject(List list,RecordSet rs) {
T_sczjBean abb = new T_sczjBean();
...
}public void init(ActionRequest actionRequest) throws Exception { this.init(0,actionRequest);}public void initAll(int i,ActionRequest actionRequest) throws Exception { this.init(i,actionRequest);}public void initAll(ActionRequest actionRequest) throws Exception { this.initAll(0,actionRequest);}public Object clone() throws CloneNotSupportedException { T_sczjBean obj = (T_sczjBean)super.clone();obj.setCorpkey(obj.corpkey);
obj.setMc(obj.mc);
