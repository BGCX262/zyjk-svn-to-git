...
public class B_sczjBean extends AbstractBasicBean implements Cloneable {
     public static List find(String sSqlWhere) throws Exception{           return new B_sczjBean().findByWhere(sSqlWhere);      }       public static List findAndLock(String sSqlWhere)throws Exception {           return new B_sczjBean().findAndLockByWhere(sSqlWhere);      }       public static B_sczjBean findFirst(String sSqlWhere)throws Exception {           return (B_sczjBean)new B_sczjBean().findFirstByWhere(sSqlWhere);      }       public static B_sczjBean findFirstAndLock(String sSqlWhere)throws Exception {           return (B_sczjBean)new B_sczjBean().findFirstAndLockByWhere(sSqlWhere);      }            public static RecordSet findRecordSet(String sSqlWhere) throws Exception{           return new B_sczjBean().findRecordSetByWhere(sSqlWhere);      }       public static List find(String sSqlWhere,boolean isAutoRelease)throws Exception {           B_sczjBean bean = new B_sczjBean();           bean.setAutoRelease(isAutoRelease);           return bean.findByWhere(sSqlWhere);      }       public static List findAndLock(String sSqlWhere,boolean isAutoRelease) throws Exception{           B_sczjBean bean = new B_sczjBean();           bean.setAutoRelease(isAutoRelease);           return bean.findAndLockByWhere(sSqlWhere);      }       public static B_sczjBean findFirst(String sSqlWhere,boolean isAutoRelease)throws Exception {           B_sczjBean bean = new B_sczjBean();           bean.setAutoRelease(isAutoRelease);           return (B_sczjBean)bean.findFirstByWhere(sSqlWhere);      }       public static B_sczjBean findFirstAndLock(String sSqlWhere,boolean isAutoRelease) throws Exception{           B_sczjBean bean = new B_sczjBean();           bean.setAutoRelease(isAutoRelease);           return (B_sczjBean)bean.findFirstAndLockByWhere(sSqlWhere);      }       public static RecordSet findRecordSet(String sSqlWhere,boolean isAutoRelease)throws Exception {           B_sczjBean bean = new B_sczjBean();           bean.setAutoRelease(isAutoRelease);           return bean.findRecordSetByWhere(sSqlWhere);      } String  corpkey;
String  mc;
String  nianliang;
String  danwei;
String  id;
String  bakdate;
public static final String TABLENAME ="b_sczj";
private String operate_mode = "add";
public ChangeFileds cf = new ChangeFileds();
public String getTableName() {return TABLENAME;}
public void addObject(List list,RecordSet rs) {
B_sczjBean abb = new B_sczjBean();
...
}public void init(ActionRequest actionRequest) throws Exception { this.init(0,actionRequest);}public void initAll(int i,ActionRequest actionRequest) throws Exception { this.init(i,actionRequest);}public void initAll(ActionRequest actionRequest) throws Exception { this.initAll(0,actionRequest);}public Object clone() throws CloneNotSupportedException { B_sczjBean obj = (B_sczjBean)super.clone();obj.setCorpkey(obj.corpkey);
obj.setMc(obj.mc);
