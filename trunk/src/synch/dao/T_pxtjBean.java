...
public class T_pxtjBean extends AbstractBasicBean implements Cloneable {
     public static List find(String sSqlWhere) throws Exception{           return new T_pxtjBean().findByWhere(sSqlWhere);      }       public static List findAndLock(String sSqlWhere)throws Exception {           return new T_pxtjBean().findAndLockByWhere(sSqlWhere);      }       public static T_pxtjBean findFirst(String sSqlWhere)throws Exception {           return (T_pxtjBean)new T_pxtjBean().findFirstByWhere(sSqlWhere);      }       public static T_pxtjBean findFirstAndLock(String sSqlWhere)throws Exception {           return (T_pxtjBean)new T_pxtjBean().findFirstAndLockByWhere(sSqlWhere);      }            public static RecordSet findRecordSet(String sSqlWhere) throws Exception{           return new T_pxtjBean().findRecordSetByWhere(sSqlWhere);      }       public static List find(String sSqlWhere,boolean isAutoRelease)throws Exception {           T_pxtjBean bean = new T_pxtjBean();           bean.setAutoRelease(isAutoRelease);           return bean.findByWhere(sSqlWhere);      }       public static List findAndLock(String sSqlWhere,boolean isAutoRelease) throws Exception{           T_pxtjBean bean = new T_pxtjBean();           bean.setAutoRelease(isAutoRelease);           return bean.findAndLockByWhere(sSqlWhere);      }       public static T_pxtjBean findFirst(String sSqlWhere,boolean isAutoRelease)throws Exception {           T_pxtjBean bean = new T_pxtjBean();           bean.setAutoRelease(isAutoRelease);           return (T_pxtjBean)bean.findFirstByWhere(sSqlWhere);      }       public static T_pxtjBean findFirstAndLock(String sSqlWhere,boolean isAutoRelease) throws Exception{           T_pxtjBean bean = new T_pxtjBean();           bean.setAutoRelease(isAutoRelease);           return (T_pxtjBean)bean.findFirstAndLockByWhere(sSqlWhere);      }       public static RecordSet findRecordSet(String sSqlWhere,boolean isAutoRelease)throws Exception {           T_pxtjBean bean = new T_pxtjBean();           bean.setAutoRelease(isAutoRelease);           return bean.findRecordSetByWhere(sSqlWhere);      } String  corpkey;
String  whdm;
String  jcrenshu;
String  jcwomen;
String  pxrenshu;
...
String  tjrenshu2;
String  tjrenshu3;
public static final String TABLENAME ="t_pxtj";
private String operate_mode = "add";
public ChangeFileds cf = new ChangeFileds();
public String getTableName() {return TABLENAME;}
public void addObject(List list,RecordSet rs) {
T_pxtjBean abb = new T_pxtjBean();
...
}public void init(ActionRequest actionRequest) throws Exception { this.init(0,actionRequest);}public void initAll(int i,ActionRequest actionRequest) throws Exception { this.init(i,actionRequest);}public void initAll(ActionRequest actionRequest) throws Exception { this.initAll(0,actionRequest);}public Object clone() throws CloneNotSupportedException { T_pxtjBean obj = (T_pxtjBean)super.clone();obj.setCorpkey(obj.corpkey);
