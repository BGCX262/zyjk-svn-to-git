...
public class T_whBean extends AbstractBasicBean implements Cloneable {
     public static List find(String sSqlWhere) throws Exception{           return new T_whBean().findByWhere(sSqlWhere);      }       public static List findAndLock(String sSqlWhere)throws Exception {           return new T_whBean().findAndLockByWhere(sSqlWhere);      }       public static T_whBean findFirst(String sSqlWhere)throws Exception {           return (T_whBean)new T_whBean().findFirstByWhere(sSqlWhere);      }       public static T_whBean findFirstAndLock(String sSqlWhere)throws Exception {           return (T_whBean)new T_whBean().findFirstAndLockByWhere(sSqlWhere);      }            public static RecordSet findRecordSet(String sSqlWhere) throws Exception{           return new T_whBean().findRecordSetByWhere(sSqlWhere);      }       public static List find(String sSqlWhere,boolean isAutoRelease)throws Exception {           T_whBean bean = new T_whBean();           bean.setAutoRelease(isAutoRelease);           return bean.findByWhere(sSqlWhere);      }       public static List findAndLock(String sSqlWhere,boolean isAutoRelease) throws Exception{           T_whBean bean = new T_whBean();           bean.setAutoRelease(isAutoRelease);           return bean.findAndLockByWhere(sSqlWhere);      }       public static T_whBean findFirst(String sSqlWhere,boolean isAutoRelease)throws Exception {           T_whBean bean = new T_whBean();           bean.setAutoRelease(isAutoRelease);           return (T_whBean)bean.findFirstByWhere(sSqlWhere);      }       public static T_whBean findFirstAndLock(String sSqlWhere,boolean isAutoRelease) throws Exception{           T_whBean bean = new T_whBean();           bean.setAutoRelease(isAutoRelease);           return (T_whBean)bean.findFirstAndLockByWhere(sSqlWhere);      }       public static RecordSet findRecordSet(String sSqlWhere,boolean isAutoRelease)throws Exception {           T_whBean bean = new T_whBean();           bean.setAutoRelease(isAutoRelease);           return bean.findRecordSetByWhere(sSqlWhere);      } String  corpkey;
String  siteid;
String  whdm;
String  source;
String  sbstate;
...
String  id;
String  jcnongmin;
public static final String TABLENAME ="t_wh";
private String operate_mode = "add";
public ChangeFileds cf = new ChangeFileds();
public String getTableName() {return TABLENAME;}
public void addObject(List list,RecordSet rs) {
T_whBean abb = new T_whBean();
...
}public void init(ActionRequest actionRequest) throws Exception { this.init(0,actionRequest);}public void initAll(int i,ActionRequest actionRequest) throws Exception { this.init(i,actionRequest);}public void initAll(ActionRequest actionRequest) throws Exception { this.initAll(0,actionRequest);}public Object clone() throws CloneNotSupportedException { T_whBean obj = (T_whBean)super.clone();obj.setCorpkey(obj.corpkey);
