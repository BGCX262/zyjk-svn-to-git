...
public class PTenumTree extends TreeBasic {
    ...
    public String getSQL(String strWhere, String strTreeID, String isFlag) {
        String strSQL = "select enutype,enuname,valuetype,enudesc,parenutype,isleaf  from ptenumain";
    ...
    public List<Map<String, Object>> getTree(RecordSet rs) {
        ...
        while (rs != null && rs.next()) {
            ...
            String pid = "1";
            String text = rs.getString("enutype");
            map.put("id", id);
            map.put("pid", pid);
            map.put("text", text);
            list.add(map);
