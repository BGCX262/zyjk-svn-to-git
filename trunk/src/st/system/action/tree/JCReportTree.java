...
public class JCReportTree extends TreeBasic{
    ...
    public String getSQL(String strWhere,String strTreeID,String isFlag) {
        ...
        public List<Map<String, Object>> getTree(RecordSet rs) {
            ...
            map.put("url", "UI/action/zyjk/JcjgbgAction_findByKey.action");
            list.add(map);
            ...
            map.put("url", "/UI/action/zyjk/JcdwjbxxAction_findByKey.action");
            list.add(map);
            ...
            map.put("pid", "0");
            map.put("text", "检测情况");
            map.put("url", "UI/zyjk/jcjg/jcjgbg/jcqk/jcqk.jsp");
            list.add(map);
            ...
            map.put("url", "UI/zyjk/jcjg/jcjgbg/jcyrdwfhssxx/jcyrdwfhssxx.jsp");
            list.add(map);
            ...
            map.put("url", "/UI/action/zyjk/JcpjjyxxAction_findByKey.action");
            list.add(map);
