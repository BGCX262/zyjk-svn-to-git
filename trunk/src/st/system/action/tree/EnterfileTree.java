...
public class EnterfileTree extends TreeBasic {
	...
	public List<Map<String, Object>> getTree(RecordSet rs) {
		...
		map.put("url", "/UI/action/enterfile/EnterMain_findByKey.action");
		list.add(map);
		...
		// map.put("id", "17");
		// map.put("pid", "4");
		// map.put("text", "建设项目“三同时");
		// map.put("url", "/UI/enterfile/zywsgljg/xzywsgljg.jsp");
		// list.add(map);
		...
		map.put("url", "/UI/enterfile/zywsxkz/zywsxkz.jsp");
		list.add(map);
