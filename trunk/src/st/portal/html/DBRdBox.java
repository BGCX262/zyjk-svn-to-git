...
public class DBRdBox {
     ...
     * @param defValue 缺省值
     */
    public DBRdBox(String id,String name,String enuType,String defValue)
    {
        radioid = id;
        radioname     = name;
     ...
     * @param enuType 枚举类型
     */
    public DBRdBox(String id,String name,String enuType)
    {
        radioid = id;
        radioname     = name;
        radioenuType  = enuType;
        ...
        try {
         ...
         while ( gridRS != null && gridRS.next() ) {
            ...
            // System.out.println(radiodefValue);
             ...
             {
                 hidevalue = value;
                 radiostr = "<tr><td><input id='"+radioid+"_"+index+"' type='radio' name='"+radioid+"' onclick='clicksel(this)' value='"+value+"' checked='checked'/><label for='"+radioname+"_"+index+"'>"+label+"</label></tr></td>";
             }else{
                 radiostr = "<tr><td><input id='"+radioid+"_"+index+"'  type='radio' name='"+radioid+"' onclick='clicksel(this)' value='"+value+"' /><label for='"+radioname+"_"+index+"'>"+label+"</label></tr></td>";
             }
