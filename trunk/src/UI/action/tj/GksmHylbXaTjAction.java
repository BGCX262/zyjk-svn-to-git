...
public class GksmHylbXaTjAction extends ActionSupport{
	 ...
	 * @return
	 */
	 @Action(value = "GksmHylbXaTjAction_getHylbTable", results = { 
			   @Result(name = MisConstant.FINDBYKEY, location = "/UI/gksm/tj/hylbxaTj.jsp") }) 
