...
public class GksmHylbTjAction extends ActionSupport{
	 ...
	 * @return
	 */
	 @Action(value = "GksmHylbTjAction_getHylbTable", results = { 
			   @Result(name = MisConstant.FINDBYKEY, location = "/UI/gksm/tj/hylbTj.jsp") }) 
