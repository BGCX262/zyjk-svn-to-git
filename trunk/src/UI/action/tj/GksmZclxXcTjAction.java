...
public class GksmZclxXcTjAction extends ActionSupport{
	 ...
	 * @return
	 */
	 @Action(value = "GksmZclxXcTjAction_getZclxTable", results = { 
			   @Result(name = MisConstant.FINDBYKEY, location = "/UI/gksm/tj/zclxxcTj.jsp") }) 
