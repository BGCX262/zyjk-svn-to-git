...
public class GksmZclxTjAction extends ActionSupport{
	 ...
	 * @return
	 */
	 @Action(value = "GksmZclxTjAction_getZclxTable", results = { 
			   @Result(name = MisConstant.FINDBYKEY, location = "/UI/gksm/tj/zclxTj.jsp") }) 
