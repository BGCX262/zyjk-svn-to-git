...
public class GksmXbTjAction extends ActionSupport{
	 ...
	 * @return
	 */
	 @Action(value = "GksmXbTjAction_getDistcodeTable", results = { 
			   @Result(name = MisConstant.FINDBYKEY, location = "/UI/gksm/tj/distcodexbTj.jsp") }) 
