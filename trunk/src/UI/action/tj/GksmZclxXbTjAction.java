...
public class GksmZclxXbTjAction extends ActionSupport{
	 ...
	 * @return
	 */
	 @Action(value = "GksmZclxXbTjAction_getZclxTable", results = { 
			   @Result(name = MisConstant.FINDBYKEY, location = "/UI/gksm/tj/zclxxbTj.jsp") }) 
	public String getZclxTable(){
	   ...
	   String dis=dept.getDistcode();
		...
		try {
			...
			rows=pt.find(" where enutype='ZCLX' order by DISPNO");
