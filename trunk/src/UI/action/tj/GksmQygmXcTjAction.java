...
public class GksmQygmXcTjAction extends ActionSupport{
	 ...
	 * @return
	 */
	 @Action(value = "GksmQygmXcTjAction_getQygmTable", results = { 
			   @Result(name = MisConstant.FINDBYKEY, location = "/UI/gksm/tj/qygmxcTj.jsp") }) 
