...
public class GksmQygmTjAction extends ActionSupport{
	 ...
	 * @return
	 */
	 @Action(value = "GksmQygmTjAction_getQygmTable", results = { 
			   @Result(name = MisConstant.FINDBYKEY, location = "/UI/gksm/tj/qygmTj.jsp") }) 
