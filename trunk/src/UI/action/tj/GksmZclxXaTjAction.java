...
public class GksmZclxXaTjAction extends ActionSupport{
	 ...
	 * @return
	 */
	 @Action(value = "GksmZclxXaTjAction_getZclxTable", results = { 
			   @Result(name = MisConstant.FINDBYKEY, location = "/UI/gksm/tj/zclxxaTj.jsp") }) 
