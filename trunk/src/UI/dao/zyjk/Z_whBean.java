...
public class Z_whBean extends AbstractBasicBean implements Cloneable {
private static final long serialVersionUID = 1L;
     public static List find(String sSqlWhere) throws Exception{           return new Z_whBean().findByWhere(sSqlWhere);      }       public static List findAndLock(String sSqlWhere)throws Exception {           return new Z_whBean().findAndLockByWhere(sSqlWhere);      }       public static Z_whBean findFirst(String sSqlWhere)throws Exception {           return (Z_whBean)new Z_whBean().findFirstByWhere(sSqlWhere);      }       public static Z_whBean findFirstAndLock(String sSqlWhere)throws Exception {           return (Z_whBean)new Z_whBean().findFirstAndLockByWhere(sSqlWhere);      }            public static RecordSet findRecordSet(String sSqlWhere) throws Exception{           return new Z_whBean().findRecordSetByWhere(sSqlWhere);      }       public static List find(String sSqlWhere,boolean isAutoRelease)throws Exception {           Z_whBean bean = new Z_whBean();           bean.setAutoRelease(isAutoRelease);           return bean.findByWhere(sSqlWhere);      }       public static List findAndLock(String sSqlWhere,boolean isAutoRelease) throws Exception{           Z_whBean bean = new Z_whBean();           bean.setAutoRelease(isAutoRelease);           return bean.findAndLockByWhere(sSqlWhere);      }       public static Z_whBean findFirst(String sSqlWhere,boolean isAutoRelease)throws Exception {           Z_whBean bean = new Z_whBean();           bean.setAutoRelease(isAutoRelease);           return (Z_whBean)bean.findFirstByWhere(sSqlWhere);      }       public static Z_whBean findFirstAndLock(String sSqlWhere,boolean isAutoRelease) throws Exception{           Z_whBean bean = new Z_whBean();           bean.setAutoRelease(isAutoRelease);           return (Z_whBean)bean.findFirstAndLockByWhere(sSqlWhere);      }       public static RecordSet findRecordSet(String sSqlWhere,boolean isAutoRelease)throws Exception {           Z_whBean bean = new Z_whBean();           bean.setAutoRelease(isAutoRelease);           return bean.findRecordSetByWhere(sSqlWhere);      } String  corpkey;
String  siteid;
String  whdm;
String  source;
String  sbstate;
...
String  id;
String  jcnongmin;
public static final String TABLENAME ="z_wh";
private String operate_mode = "add";
public ChangeFileds cf = new ChangeFileds();
public String getTableName() {return TABLENAME;}
 @SuppressWarnings("unchecked")
public void addObject(List list,RecordSet rs) {
Z_whBean abb = new Z_whBean();
...
}public void init(ActionRequest actionRequest) throws Exception { this.init(0,actionRequest);}public void initAll(int i,ActionRequest actionRequest) throws Exception { this.init(i,actionRequest);}public void initAll(ActionRequest actionRequest) throws Exception { this.initAll(0,actionRequest);}public Object clone() throws CloneNotSupportedException { Z_whBean obj = (Z_whBean)super.clone();obj.setCorpkey(obj.corpkey);
