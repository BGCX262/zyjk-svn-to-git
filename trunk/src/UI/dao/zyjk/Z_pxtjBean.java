...
public class Z_pxtjBean extends AbstractBasicBean implements Cloneable {
private static final long serialVersionUID = 1L;
     public static List find(String sSqlWhere) throws Exception{           return new Z_pxtjBean().findByWhere(sSqlWhere);      }       public static List findAndLock(String sSqlWhere)throws Exception {           return new Z_pxtjBean().findAndLockByWhere(sSqlWhere);      }       public static Z_pxtjBean findFirst(String sSqlWhere)throws Exception {           return (Z_pxtjBean)new Z_pxtjBean().findFirstByWhere(sSqlWhere);      }       public static Z_pxtjBean findFirstAndLock(String sSqlWhere)throws Exception {           return (Z_pxtjBean)new Z_pxtjBean().findFirstAndLockByWhere(sSqlWhere);      }            public static RecordSet findRecordSet(String sSqlWhere) throws Exception{           return new Z_pxtjBean().findRecordSetByWhere(sSqlWhere);      }       public static List find(String sSqlWhere,boolean isAutoRelease)throws Exception {           Z_pxtjBean bean = new Z_pxtjBean();           bean.setAutoRelease(isAutoRelease);           return bean.findByWhere(sSqlWhere);      }       public static List findAndLock(String sSqlWhere,boolean isAutoRelease) throws Exception{           Z_pxtjBean bean = new Z_pxtjBean();           bean.setAutoRelease(isAutoRelease);           return bean.findAndLockByWhere(sSqlWhere);      }       public static Z_pxtjBean findFirst(String sSqlWhere,boolean isAutoRelease)throws Exception {           Z_pxtjBean bean = new Z_pxtjBean();           bean.setAutoRelease(isAutoRelease);           return (Z_pxtjBean)bean.findFirstByWhere(sSqlWhere);      }       public static Z_pxtjBean findFirstAndLock(String sSqlWhere,boolean isAutoRelease) throws Exception{           Z_pxtjBean bean = new Z_pxtjBean();           bean.setAutoRelease(isAutoRelease);           return (Z_pxtjBean)bean.findFirstAndLockByWhere(sSqlWhere);      }       public static RecordSet findRecordSet(String sSqlWhere,boolean isAutoRelease)throws Exception {           Z_pxtjBean bean = new Z_pxtjBean();           bean.setAutoRelease(isAutoRelease);           return bean.findRecordSetByWhere(sSqlWhere);      } String  corpkey;
String  whdm;
String  jcrenshu;
String  jcwomen;
String  pxrenshu;
...
String  tjrenshu2;
String  tjrenshu3;
public static final String TABLENAME ="z_pxtj";
private String operate_mode = "add";
public ChangeFileds cf = new ChangeFileds();
public String getTableName() {return TABLENAME;}
 @SuppressWarnings("unchecked")
public void addObject(List list,RecordSet rs) {
Z_pxtjBean abb = new Z_pxtjBean();
...
}public void init(ActionRequest actionRequest) throws Exception { this.init(0,actionRequest);}public void initAll(int i,ActionRequest actionRequest) throws Exception { this.init(i,actionRequest);}public void initAll(ActionRequest actionRequest) throws Exception { this.initAll(0,actionRequest);}public Object clone() throws CloneNotSupportedException { Z_pxtjBean obj = (Z_pxtjBean)super.clone();obj.setCorpkey(obj.corpkey);
