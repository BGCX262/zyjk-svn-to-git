...
public class Z_sccpBean extends AbstractBasicBean implements Cloneable {
private static final long serialVersionUID = 1L;
     public static List find(String sSqlWhere) throws Exception{           return new Z_sccpBean().findByWhere(sSqlWhere);      }       public static List findAndLock(String sSqlWhere)throws Exception {           return new Z_sccpBean().findAndLockByWhere(sSqlWhere);      }       public static Z_sccpBean findFirst(String sSqlWhere)throws Exception {           return (Z_sccpBean)new Z_sccpBean().findFirstByWhere(sSqlWhere);      }       public static Z_sccpBean findFirstAndLock(String sSqlWhere)throws Exception {           return (Z_sccpBean)new Z_sccpBean().findFirstAndLockByWhere(sSqlWhere);      }            public static RecordSet findRecordSet(String sSqlWhere) throws Exception{           return new Z_sccpBean().findRecordSetByWhere(sSqlWhere);      }       public static List find(String sSqlWhere,boolean isAutoRelease)throws Exception {           Z_sccpBean bean = new Z_sccpBean();           bean.setAutoRelease(isAutoRelease);           return bean.findByWhere(sSqlWhere);      }       public static List findAndLock(String sSqlWhere,boolean isAutoRelease) throws Exception{           Z_sccpBean bean = new Z_sccpBean();           bean.setAutoRelease(isAutoRelease);           return bean.findAndLockByWhere(sSqlWhere);      }       public static Z_sccpBean findFirst(String sSqlWhere,boolean isAutoRelease)throws Exception {           Z_sccpBean bean = new Z_sccpBean();           bean.setAutoRelease(isAutoRelease);           return (Z_sccpBean)bean.findFirstByWhere(sSqlWhere);      }       public static Z_sccpBean findFirstAndLock(String sSqlWhere,boolean isAutoRelease) throws Exception{           Z_sccpBean bean = new Z_sccpBean();           bean.setAutoRelease(isAutoRelease);           return (Z_sccpBean)bean.findFirstAndLockByWhere(sSqlWhere);      }       public static RecordSet findRecordSet(String sSqlWhere,boolean isAutoRelease)throws Exception {           Z_sccpBean bean = new Z_sccpBean();           bean.setAutoRelease(isAutoRelease);           return bean.findRecordSetByWhere(sSqlWhere);      } String  corpkey;
String  mc;
String  nianliang;
String  danwei;
String  id;
public static final String TABLENAME ="z_sccp";
private String operate_mode = "add";
public ChangeFileds cf = new ChangeFileds();
public String getTableName() {return TABLENAME;}
 @SuppressWarnings("unchecked")
public void addObject(List list,RecordSet rs) {
Z_sccpBean abb = new Z_sccpBean();
...
}public void init(ActionRequest actionRequest) throws Exception { this.init(0,actionRequest);}public void initAll(int i,ActionRequest actionRequest) throws Exception { this.init(i,actionRequest);}public void initAll(ActionRequest actionRequest) throws Exception { this.initAll(0,actionRequest);}public Object clone() throws CloneNotSupportedException { Z_sccpBean obj = (Z_sccpBean)super.clone();obj.setCorpkey(obj.corpkey);
obj.setMc(obj.mc);
